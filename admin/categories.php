...
function add_category(){
  ...
  xiu_execute("insert into categories values(null,'{$name}','{$slug}');");
...
function edit_catgory(){
  ...
  $slug = empty($_POST['slug']) ? $current_edit_category['name'] : $_POST['slug'];

  xiu_execute("update categories set slug ='{$slug}' ,name='{$name}' where id = {$id}");
 }
...
//查询    数据渲染列表
$categories_current = xiu_fetch_all('select * from categories');

// var_dump($categories_current[0]['name']);
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
             <?php foreach ($categories_current as $item): ?>
                <tr>
